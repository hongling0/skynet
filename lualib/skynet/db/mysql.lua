...
function _M.ping(self)
    local sockchannel = self.sockchannel
    local packet = _compose_query(self, COM_PING)
...
local BINARY_WRITER={
    ...
    [7]=nil,    --MYSQL_TYPE_TIMESTAMP,write_datatime
    [8]=function(v) return strpack("<I8", v)end,    --MYSQL_TYPE_LONGLONG,
    [9]=function(v) return _set_byte4(v) end,    --MYSQL_TYPE_INT24,
    [10]=nil,    --MYSQL_TYPE_DATE, write_data
    [11]=nil,    --MYSQL_TYPE_TIME, write_time
    [12]=nil,    --MYSQL_TYPE_DATETIME,write_datatime
...
local BINARY_READER={
    ...
    [9]=function(v,p) return _get_byte4(v,p),p+4 end,    --MYSQL_TYPE_INT24,
